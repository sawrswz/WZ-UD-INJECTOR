...
void discordOpen()
{
	ShellExecute(NULL, "open", "https://discord.gg/dUkGMgUq", NULL, NULL, SW_SHOWNORMAL);
}
...
int main()
{
 ...
 //   SetConsoleMode(hInput, prev_mode & ENABLE_EXTENDED_FLAGS);
	...
	SetConsoleTitleA("SAWR SOLUTIONS");
...
login:
	...
	if (auth)
	{
		...
		MessageBox(NULL, "Driver Succesfully Loaded", "SAWR KERNAL INJECTOR", MB_OK);
